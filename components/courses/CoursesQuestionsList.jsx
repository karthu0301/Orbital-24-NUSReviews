import './CoursesQuestionsList.css';
...
const CoursesQuestionsList = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      let q = collection(db, "courseQuestions");
  ...
  const handleQuestionSubmit = async (e) => {
    ...
    { id: 'humanitiesandsciences', name: 'Humanities and Sciences' },
  ...
  return (
    ...
    <div className="courses-questions-list">
        ...
        <table>
          ...
          <tbody>
            {questions.map(question => (
              <tr key={question.id}>
                <td>
                  <Link to={`/courses/questions/${question.id}`}>{question.text}</Link>
                </td>
