    ...
    <div className="login-main-content">
      <div className="login-container">
        ...
        <form onSubmit={handleLogin} data-testid="login-form">
          ...
          />
          <button type="submit" className="login-button" data-testid="submit-button">Continue</button>
        ...
        <div className="microsoft-button" onClick={handleMicrosoftLogin} data-testid="microsoft-login-button">
          <img src={microsoftSignIn} alt="Sign in with Microsoft" />
        </div>
        <p>Note: You can freely explore the website without logging in. An account is only required to answer question threads or vote on polls.</p>
      </div>
    </div>
  );
};
